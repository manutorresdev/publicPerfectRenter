        ...
        <div className='newProperty-card-container flex justify-around flex-col-reverse gap-10 '>
          ...
          >
            ...
            <label className='relative'>
              ...
              <textarea
                className='px-3 pt-3 pb-5 placeholder-gray-400 text-gray-600 relative bg-white rounded text-sm border border-gray-400 outline-none focus:outline-none focus:ring w-full h-20'
                type='text'
                name='description'
                cols='20'
                maxLength='3000'
